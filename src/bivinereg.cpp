                 ...
                 const std::vector<std::string>& var_types)
{
  ...
  // std::cout << "rank_order: \n";
  // std::cout << rank_order[0] << ", " << rank_order[1] << ", " << rank_order[2] << ", " << rank_order[3] << ", " << rank_order[4] << ", " << rank_order[5] << "\n";
  ...
  // std::cout << "rows: \n";
  // std::cout << rows[0][0] << ", " << rows[0][1] << ", "<< rows[0][2] << ", "<< rows[0][3] << ", " << rows[0][4] << "\n";
  // std::cout << rows[1][0] << ", " << rows[1][1] << ", "<< rows[1][2] << ", "<< rows[1][3] << "\n";
  // std::cout << rows[2][0] << ", " << rows[2][1] << ", "<< rows[2][2] << "\n";
  // std::cout << rows[3][0] << ", " << rows[3][1] << "\n";
  // std::cout << rows[4][0] << "\n";
  ...
  // auto test = new_struct.get_struct_array();
  // std::cout << "Rvine array: \n";
  // std::cout << test << "\n";
  // std::cout << new_struct.get_matrix();
